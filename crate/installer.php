...

{
    ...
    $manifest = file_get_contents('https://cmpayments.github.io/crate/manifest.json');
    ...
    echo " - Downloading Crate v", Dumper::toString($item->version), "...$n";
    ...
    echo " - Making Crate executable...$n";

    @chmod($item->name, 0755);

    echo "{$n}Crate installed!$n";
